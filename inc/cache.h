...
class CACHE : public champsim::operable, public MemoryRequestConsumer, public MemoryRequestProducer {
  public:
    ...
    CACHE(std::string v1, double freq_scale, unsigned fill_level, uint32_t v2, int v3, uint32_t v5, uint32_t v6, uint32_t v7, uint32_t v8,
            uint32_t hit_lat, uint32_t fill_lat, uint32_t max_read, uint32_t max_write, bool pref_load, bool wq_full_addr, MemoryRequestConsumer *ll,
            ...
            std::function<uint32_t(CACHE*, uint64_t, uint64_t, uint32_t, uint32_t, uint8_t, uint64_t, uint32_t)> pref_cache_fill,
        ...
        prefetch_as_load(pref_load), wq_check_full_addr(wq_full_addr),
    ...
    uint32_t cpu_redir_ipref_operate(uint64_t, uint64_t, uint64_t, uint8_t, uint8_t, uint32_t);
    uint32_t cpu_redir_ipref_fill(uint64_t, uint64_t, uint32_t, uint32_t, uint8_t, uint64_t, uint32_t);
    void cpu_redir_ipref_cycle_operate();
    void cpu_redir_ipref_final_stats();

    const std::function<void()> impl_prefetcher_initialize;
    const std::function<uint32_t(uint64_t, uint64_t, uint64_t, uint8_t, uint8_t, uint32_t)> impl_prefetcher_operate;
    const std::function<uint32_t(uint64_t, uint64_t, uint32_t, uint32_t, uint8_t, uint64_t, uint32_t)> impl_prefetcher_cache_fill;
