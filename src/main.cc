...
int main(int argc, char** argv)
{
	...
	ooo_cpu[i].ITLB.MAX_WRITE = 2;
        ...
        ooo_cpu[i].STLB.lower_level = &ooo_cpu[i].page_walker;

        ooo_cpu[i].page_walker.lower_level = &ooo_cpu[i].L1D;
        ooo_cpu[i].page_walker.upper_level_icache[i] = &ooo_cpu[i].STLB;
        ooo_cpu[i].page_walker.upper_level_dcache[i] = &ooo_cpu[i].STLB;
